...
public class Main {
	...
	public static void main(String[] args) {
		...
		double imposto3 = (salario - faixa3) * aliquota3 + (faixa3 - faixa2) * aliquota2
				+ (faixa2 - faixa1) * aliquota1;
		double imposto4 = (salario - faixa4) * aliquota4 + (faixa4 - faixa3) * aliquota3 + (faixa3 - faixa2) * aliquota2
				+ (faixa2 - faixa1) * aliquota1;
